...
return array(
    ...
    */
    ...
    'attributes' => array(
		...
		"newPassword_confirmation" => "تأكيد كلمة السر الجديدة ",
		"comment_content"=>"محتوى التعليق ",
		"community_title"=>"أسم المجتمع ",
		"community_slug"=>"أسم المجتمع القصير ",
		"community_description"=>"النبذة عن المجتمع ",
		"link"=> "الرابط ",
		
		"community_id" => "المجتمع ",
		"confirm"=>"الموافقة على قانون المشاركة ",
